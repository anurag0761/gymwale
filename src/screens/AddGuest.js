...
import {
  ...
  addOrEditMemberStaff,
} from '../Redux/Actions/addOrEditMember';
...
class AddGuest extends Component {
  ...
  addGuest = async () => {
    ...
    data.append(Constants.KEY_MEMBER_TYPE, Constants.MEMBER_TYPE_GUEST);
    ...
    //console.log("BODY:::");
    //console.log(data);
    this.props.addoreditmember(data);
    setTimeout(() => {
      if (this.props.Success) {
        ...
        if (valid) {
          ...
          thisInstance.showGuestAddedAlert();
        }
      } else {
    ...
    return (
      <TouchableWithoutFeedback
        ...
        <View
          ...
          <TouchableOpacity style={{width: '100%'}} onPress={this.addGuest}>
